...
static void log_file_size_check(void)
{
	...
	switch (mfts_mode) {
	case 0:
		filename = "/mnt/sdcard/touch_self_test.txt";
		break;
	case 1:
		filename = "/mnt/sdcard/touch_self_test_mfts_folder.txt";
		break;
	case 2:
		filename = "/mnt/sdcard/touch_self_test_mfts_flat.txt";
		break;
	case 3:
		filename = "/mnt/sdcard/touch_self_test_mfts_curved.txt";
		break;
	default:

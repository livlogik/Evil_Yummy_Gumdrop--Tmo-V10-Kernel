...
#ifdef CONFIG_MACH_MSM8992_PPLUS_VZW
...
#if defined CONFIG_USB_G_LGE_ANDROID && !defined CONFIG_MACH_MSM8992_PPLUS_VZW
					/*
...
#if defined (CONFIG_DWC3_MSM_BC_12_VZW_SUPPORT) && defined (CONFIG_LGE_PM_USB_ID)
